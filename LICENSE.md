# End-User License Agreement (EULA) of Quicksilver

This End-User License Agreement (\"EULA\") is a legal agreement between
you and Etch.

This EULA agreement governs your acquisition and use of our Quicksilver
software (\"Software\") directly from Etch.

Please read this EULA agreement carefully before completing the
installation process and using the Quicksilver software. It provides a
license to use the Quicksilver software and contains warranty
information and liability disclaimers.

By clicking \"accept\" or installing and/or using the Quicksilver
...
This EULA agreement shall apply only to the Software supplied by Etch
herewith regardless of whether other software is referred to or
described herein. The terms also apply to any Etch updates, supplements,
...
Etch hereby grants you a personal, non-transferable, non-exclusive
license to use the Quicksilver software on your devices in accordance
with the terms of this EULA agreement.

You are permitted to load the Quicksilver software (for example a PC,
laptop, mobile or tablet) under your control. You are responsible for
ensuring your device meets the minimum requirements of the Quicksilver
software.
...
- Use the Software for any purpose that Etch considers is a breach of
  this EULA agreement

## Intellectual Property and Ownership

Etch shall at all times retain ownership of the Software as originally
...
thereto) are and shall remain the property of Etch.

Etch reserves the right to grant licenses to use the Software to third
parties.
...
any time upon written notice to Etch.
