...
struct AnalyzerView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("Please play music as you would normally on your Mac. As the music is playing, press Analyze and allow music to play for 30 seconds to avoid incomplete results.")
                .font(.system(size: 14))
